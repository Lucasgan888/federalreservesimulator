...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert prose-blue">
      ...
      <p>Federal Reserve Simulator is a client-side application. All data is processed in your browser. We do not collect, store, or transmit any personal information.</p>
      <h2>Analytics</h2>
