...
export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert prose-blue">
      ...
      <p>By accessing and using Federal Reserve Simulator, you agree to these terms of service.</p>
      <h2>Description of Service</h2>
      <p>Federal Reserve Simulator is a free online tool for entertainment and educational purposes. The service is provided &quot;as is&quot; without warranties of any kind.</p>
      <h2>User Conduct</h2>
      <p>You agree to use the service only for lawful purposes and in accordance with these terms.</p>
      <h2>Intellectual Property</h2>
      <p>Not affiliated with the Federal Reserve System. For educational purposes only. The website code and design are original works.</p>
